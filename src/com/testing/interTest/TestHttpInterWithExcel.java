...
public class TestHttpInterWithExcel {
	...
	public static void main(String[] args) {
		...
		//打开Excel表进行读取
		ExcelReader excelR = new ExcelReader("cases/RESTLogin.xlsx");
		//复制用例中的内容到结果中，并执行之后的写入操作
		ExcelWriter excelW = new ExcelWriter("cases/RESTLogin.xlsx", "cases/Res-RESTLogin"+createdate+".xlsx");
		//创建关键字类
